    ...
    return (
        <div>
            ...
            <div className="mx-auto w-75 my-5 pt-0 mt-0">
                {searchedDoctorsSpecialty && (
                    <h4 className="text-center mb-0 pb-0">
                        <strong className="text-primary fs-3 fw-bold">{availableDoctors.length}</strong> doctors
                        available
                    </h4>
                )}
                <h5 className="text-center opacity-50 mt-0 pt-0">
                    {" "}
            ...
            {availableDoctors.length ? (
                <>
                    ...
                    <ReviewForm avalableDocs={availableDoctors} />
                </>
            ) : null}
        </div>
    );
